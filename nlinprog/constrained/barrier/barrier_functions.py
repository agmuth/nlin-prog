...
from nlinprog.constants import ZERO_MINUS, ZERO_PLUS
...
class InverseBarrierFunction(BarrierFunction):
    def __call__(self, g: callable) -> callable:
        """Construct + return the inverse barrier function wrt to `g`"""
...
BARRIER_FUNCTIONS_MAPPING = MappingProxyType(
    {"inverse": InverseBarrierFunction, "logarithmic": LogarithmicBarrierFunction}
)
